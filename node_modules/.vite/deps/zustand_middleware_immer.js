...
var immerImpl = (initializer) => (set$1, get$1, store) => {
	store.setState = (updater, replace, ...args) => {
		return set$1(typeof updater === "function" ? produce(updater) : updater, replace, ...args);
	};
	return initializer(store.setState, get$1, store);
};
var immer = immerImpl;
